...
public class BusinessAssert {
     ...
     * @param object     the object to find within the collection
     * @param code       the exception code to use if the assertion fails
     * @param message    the exception message to use if the assertion fails
     * @throws BusinessException if the collection is {@code null} or has no entries or does not contain given object
     */
     ...
     * @param code       the exception code to use if the assertion fails
     * @param message    the exception message to use if the assertion fails
     * @throws BusinessException if the expected object not equals with actual object
     */
     ...
     * @param code       the exception code to use if the assertion fails
     * @param message    the exception message to use if the assertion fails
     * @throws BusinessException if the expected string not equals with actual string
     */
